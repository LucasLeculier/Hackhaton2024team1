...
folder_path = "../webp/mobbin_trier"
#Récupérer dans la DB les noms de fichier qui sont déja importés



files = [f for f in os.listdir(folder_path) if os.path.isfile(os.path.join(folder_path, f))]
#files = files[10:40]  # Cela récupère les éléments de l'index 10 à 19
...
for file in files:
    ...
    insert_query = """
    INSERT INTO mobbin (image_id,couleur,couleur_dominante, formes_principales_et_taille, layout, style_general, navigation, hierarchie_visuelle)
